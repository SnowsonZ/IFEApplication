...
import net.kimhou.playersdk.exoplayerwrapper.DashRendererBuilder;
import net.kimhou.playersdk.exoplayerwrapper.DefaultRendererBuilder;
import net.kimhou.playersdk.exoplayerwrapper.DemoPlayer;
import net.kimhou.playersdk.exoplayerwrapper.HlsRendererBuilder;
import net.kimhou.playersdk.exoplayerwrapper.Util;

import util.VPUtil;


public class PlayerSDKActivity extends Activity implements View.OnClickListener, SurfaceHolder.Callback, ExoPlayer.Listener, MediaCodecVideoTrackRenderer.EventListener{
...
//        url = intent.getStringExtra(PlayerConst.VIDEO_URL);
        url = "http://192.168.10.60/data/source/video/A_004_0030_256/1/default.m3u8";
